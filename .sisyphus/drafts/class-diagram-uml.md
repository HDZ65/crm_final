# Diagramme de Classes UML - CRM Final

> **Comment utiliser** : Copiez chaque bloc `mermaid` et collez-le dans [mermaid.live](https://mermaid.live) pour le visualiser.

---

## 1/4 — SHARED KERNEL : Value Objects, Base Classes & Exceptions
...
## 2/4 — SERVICE-CORE : Users, Organisations, Clients, Documents
...
## 3/4 — SERVICE-FINANCE : Factures, Payments, Calendar
...
## 4/4 — SERVICE-ENGAGEMENT & SERVICE-LOGISTICS
...
## 5/5 — DIAGRAMME DE RELATIONS INTER-SERVICES (Vue Macro)
...
| Bounded Context | Service | Entites | Relations |
|---|---|---|---|
| **Shared Kernel** | packages/shared-kernel | 17 classes (9 UUID VOs, 2 String VOs, 3 Numeric VOs, 1 Complex VO, 2 Base) + 6 Exceptions | 16 heritage |
| **Users** | service-core | 7 entites | 6 associations |
| **Organisations** | service-core | 5 entites | 5 associations |
| **Clients** | service-core | 8 entites | 3 associations |
| **Documents** | service-core | 2 entites | 0 |
| **Factures** | service-finance | 9 entites | 7 associations |
| **Payments** | service-finance | 27 entites | 12 associations |
| **Calendar** | service-finance | 11 entites | 2 associations |
| **Engagement** | service-engagement | 11 entites | 2 associations |
| **Services** | service-engagement | 4 entites | 1 association |
| **Logistics** | service-logistics | 4 entites | 3 associations |
| **Fulfillment** | service-logistics | 5 entites + 2 services | 5 associations |
| **TOTAL** | | **~110 classes** | **~62 relations** |
