...
export class UserRoleDto {
  ...
  @ApiProperty({ description: 'Role code (e.g., owner, member)' })
  code: string;
...
export class UserOrganisationDto {
  ...
  @ApiProperty({ description: 'User role ID in this organisation (deprecated, use role object)' })
  roleId: string;

  @ApiProperty({ description: 'User role in this organisation', type: UserRoleDto })
  role: UserRoleDto;
...
export class UserProfileResponseDto {
  ...
  @ApiProperty({
    description:
      'Whether user has at least one organisation - use this to redirect to organisation creation page',
  })
