import {
  ...
  ProfilRemuneration,
  CanalVente,
} from '../../core/domain/bareme-commission.entity';
...
export class BaremeCommissionMapper {
  static toDomain(
    ...
    return new BaremeCommissionEntity({
      ...
      typeCalcul: ormEntity.typeCalcul as TypeCalcul,
      baseCalcul: ormEntity.baseCalcul as BaseCalcul,
      ...
      typeProduit: ormEntity.typeProduit as TypeProduit | null,
      profilRemuneration:
        ormEntity.profilRemuneration as ProfilRemuneration | null,
      societeId: ormEntity.societeId,
      canalVente: ormEntity.canalVente as CanalVente | null,
