...
export class GetHistoriqueRelanceUseCase {
  ...
  async existsForToday(
    ...
    return await this.repository.existsForToday(
      regleRelanceId,
      clientId,
      contratId,
      factureId,
