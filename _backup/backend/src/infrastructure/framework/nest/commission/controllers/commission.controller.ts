...
export class CommissionController {
  ...
  @ApiOperation({
    summary:
      'Récupérer la configuration pour le frontend (types, statuts, etc.)',
  })
  getConfig() {
    return {
      typesApporteur: [
      ...
      typesCalcul: [
        {
          value: 'fixe',
          label: 'Montant Fixe',
          description: 'Montant fixe par contrat',
        },
        {
          value: 'pourcentage',
          label: 'Pourcentage',
          description: 'Pourcentage de la base de calcul',
        },
        {
          value: 'palier',
          label: 'Palier',
          description: 'Montant selon seuils atteints',
        },
        {
          value: 'mixte',
          label: 'Mixte',
          description: 'Fixe + pourcentage combinés',
        },
      ],
      typesBase: [
        {
          value: 'cotisation_ht',
          label: 'Cotisation HT',
          description: 'Base sur cotisation hors taxes',
        },
        {
          value: 'ca_ht',
          label: 'CA HT',
          description: "Base sur chiffre d'affaires hors taxes",
        },
        {
          value: 'forfait',
          label: 'Forfait',
      ...
      statutsLigne: [
        ...
        {
          value: 'deselectionnee',
          label: 'Désélectionnée',
          color: 'bg-orange-500/10 text-orange-600',
        },
        {
          value: 'validee',
      ...
      typesPalier: [
        {
          value: 'volume',
          label: 'Volume',
          description: 'Basé sur le nombre de contrats',
        },
        {
          value: 'ca',
          label: "Chiffre d'Affaires",
          description: 'Basé sur le CA cumulé',
        },
        {
          value: 'prime_produit',
          label: 'Prime Produit',
          description: 'Prime par type de produit',
        },
      ],
      dureesReprise: [
