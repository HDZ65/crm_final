...
import { FactureFiltersDto } from '../../../../../applications/dto/facture/facture-filters.dto';
...
export class FactureController {
  ...
  @Get()
  async findAll(@Query() filters: FactureFiltersDto): Promise<FactureDto[]> {
    const entities = await this.getUseCase.executeAll(filters);
