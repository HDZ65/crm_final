...
export const toolDefs: readonly ToolDef[] = [
  ...
  // =========================
  {
    ...
    description: 'Crée un contrat. Mappe: POST /contrats (CreateContratDto).',
    input_schema: {
      type: 'object',
      properties: {
        // Tenant
  ...
  },
  {
    ...
    description:
      'POST /orchestration/contracts/{contractId}/(activate|suspend|terminate|port-in)',
    input_schema: {
      type: 'object',
      properties: {
        organisationId: { type: 'string' },
        ...
        action: {
          type: 'string',
          enum: ['activate', 'suspend', 'terminate', 'port-in'],
        },
        reason: { type: 'string' },
  ...
  {
    name: 'create_invoice',
    description: 'Crée une facture. Mappe: POST /factures (CreateFactureDto).',
    input_schema: {
      type: 'object',
      properties: {
        // Tenant
