...
export class AlerteDto {
  ...
  @ApiProperty({ enum: ['critique', 'avertissement', 'info'], description: 'Niveau de l\'alerte' })
  niveau: NiveauAlerte;

  @ApiProperty({ enum: ['taux_impayes', 'taux_churn', 'controles_qualite', 'objectif_ca', 'autre'], description: 'Type d\'alerte' })
  type: TypeAlerte;
  ...
  @ApiProperty({ description: 'Entité concernée (société, produit, etc.)', required: false })
