...
export class ClassementCommercialDto {
  ...
  @ApiProperty({ description: 'Valeur (nombre de ventes, CA ou taux de conversion)' })
  valeur: number;
...
export class KpisCommerciauxResponseDto {
  ...
  @ApiProperty({ description: 'Variation des nouveaux clients vs mois dernier', type: VariationKpiDto })
  nouveauxClientsVariation: VariationKpiDto;

  @ApiProperty({ description: 'Taux de conversion en pourcentage' })
  tauxConversion: number;

  @ApiProperty({ description: 'Variation du taux de conversion vs mois dernier', type: VariationKpiDto })
  tauxConversionVariation: VariationKpiDto;

  @ApiProperty({ description: 'Panier moyen en euros' })
  panierMoyen: number;

  @ApiProperty({ description: 'Variation du panier moyen vs mois dernier', type: VariationKpiDto })
  ...
  @ApiProperty({ description: 'Classement des commerciaux par nombre de ventes', type: [ClassementCommercialDto] })
  classementParVentes: ClassementCommercialDto[];

  @ApiProperty({ description: 'Classement des commerciaux par chiffre d\'affaires', type: [ClassementCommercialDto] })
  classementParCA: ClassementCommercialDto[];

  @ApiProperty({ description: 'Classement des commerciaux par taux de conversion', type: [ClassementCommercialDto] })
