...
export class UpdateBaremeCommissionUseCase {
  ...
  async execute(
    ...
    if (dto.typeCalcul !== undefined) existing.typeCalcul = dto.typeCalcul as any;
    if (dto.baseCalcul !== undefined) existing.baseCalcul = dto.baseCalcul as any;
    ...
    if (dto.typeProduit !== undefined) existing.typeProduit = dto.typeProduit as any;
    ...
    if (dto.dateEffet !== undefined) existing.dateEffet = new Date(dto.dateEffet);
  ...
  async executeNouvelleVersion(
    ...
    return await this.repository.creerNouvelleVersion(id, dto as any, modifiePar, motif);
  }
}
