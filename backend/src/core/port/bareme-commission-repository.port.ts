...
export interface BaremeCommissionRepositoryPort
  extends BaseRepositoryPort<BaremeCommissionEntity> {
  findByOrganisationId(organisationId: string): Promise<BaremeCommissionEntity[]>;
