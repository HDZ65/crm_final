...
export interface PalierCommissionRepositoryPort
  extends BaseRepositoryPort<PalierCommissionEntity> {
  findByOrganisationId(organisationId: string): Promise<PalierCommissionEntity[]>;
