...
export class NotificationController {
  ...
  @Get()
  async findAll(@Query('utilisateurId') utilisateurId?: string): Promise<NotificationDto[]> {
    if (utilisateurId) {
      const entities = await this.getUseCase.executeByUtilisateurId(utilisateurId);
