...
import type { WinLeadPlusTestConnectionResponse as TestConnectionResponse } from "@/lib/grpc/clients/winleadplus";
...
export async function saveWinLeadPlusConfig(params: {
  ...
  try {
    const data = await winleadplus.saveConfig({
      ...
      syncIntervalMinutes: params.syncIntervalMinutes ?? 60,
