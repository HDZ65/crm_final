...
export default function InvitePage() {
  ...
  const { validation, isLoading: isValidating, error: validationError, validateInvitation } = useValidateInvitation();
  const { isLoading: isAccepting, acceptInvitation } = useAcceptInvitation();
