...
import type { ProductFilters, ProductType, ProductCategory, ProductStatus } from "@/types/product"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleFilterChange("category", value === "all" ? undefined : (value as ProductCategory))
                  }
                >
