...
import type { Product, UpdateProduitDto } from "@/types/product"
import type { SocieteDto } from "@/hooks/clients/use-groupe-entites"
...
export function EditProductDialog({
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    await onSubmit(product.id, {
      ...
      actif: values.actif,
      promotionActive: values.promotionActive,
      promotionPourcentage: values.promotionActive ? values.promotionPourcentage : undefined,
      promotionDateDebut: values.promotionActive ? values.promotionDateDebut : undefined,
      promotionDateFin: values.promotionActive ? values.promotionDateFin : undefined,
    })
  }
