...
import { Mail, MoreVertical, Shield, Trash2, UserPlus, Crown, Copy, Check, Link } from "lucide-react"
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
const roleDescriptions: Record<OrganizationRole, string> = {
    owner: "Tous les droits, peut supprimer l'organisation",
    admin: "Peut inviter et gérer les utilisateurs",
...
export function OrganizationMembersDialog({
    ...
    // Les owners et admins peuvent gérer les membres existants
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Membres de {organizationName}</DialogTitle>
                    <DialogDescription>
                            ...
                            {Object.entries(roleDescriptions).map(([role, description]) => {
                                ...
                                return (
                                    <div key={role} className="flex items-start gap-2">
                                        ...
                                        <div>
                                            <p className="font-medium">{roleLabels[role as OrganizationRole]}</p>
