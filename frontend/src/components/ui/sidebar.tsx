...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* This is 0at handles the sidebar gap on desktop */}
      <div
...
function SidebarMenuSkeleton({
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 max-w-(--skeleton-width) flex-1 bg-muted animate-pulse rounded"
