  ...
  typesReprise: [
    {
      value: "resiliation",
      label: "Résiliation",
      description: "Le contrat a été résilié",
    },
    {
      value: "impaye",
      label: "Impayé",
      description: "Impayés constatés sur le contrat",
    },
    {
      value: "annulation",
      label: "Annulation",
  ...
  typesBase: [
    {
      value: "cotisation_ht",
      label: "Cotisation HT",
      description: "Base sur la cotisation HT",
    },
    {
      value: "ca_ht",
      label: "CA HT",
      description: "Base sur le chiffre d'affaires HT",
    },
    {
      value: "forfait",
      label: "Forfait",
      description: "Base forfaitaire",
    },
  ],
  typesPalier: [
    { value: "volume", label: "Volume", description: "Palier basé sur le volume" },
    {
      ...
      description: "Palier basé sur le CA",
    },
    {
      value: "prime_produit",
      label: "Prime produit",
      description: "Prime par produit vendu",
    },
  ],
  statutsReprise: [
    {
