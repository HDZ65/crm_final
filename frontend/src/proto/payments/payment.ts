...
import { CreateJournalExportRequest, GetJournalExportFormatsResponse, JournalExportResponse } from "./export-fec";
...
export const PaymentServiceService = {
  ...
  createJournalExport: {
    path: "/payment.PaymentService/CreateJournalExport",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateJournalExportRequest): Buffer =>
      Buffer.from(CreateJournalExportRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateJournalExportRequest => CreateJournalExportRequest.decode(value),
    responseSerialize: (value: JournalExportResponse): Buffer =>
      Buffer.from(JournalExportResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): JournalExportResponse => JournalExportResponse.decode(value),
  },
  getJournalExportFormats: {
    path: "/payment.PaymentService/GetJournalExportFormats",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateJournalExportRequest): Buffer =>
      Buffer.from(CreateJournalExportRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateJournalExportRequest => CreateJournalExportRequest.decode(value),
    responseSerialize: (value: GetJournalExportFormatsResponse): Buffer =>
      Buffer.from(GetJournalExportFormatsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetJournalExportFormatsResponse =>
      GetJournalExportFormatsResponse.decode(value),
  },
  /** ==================== RISK SCORING ==================== */
  getRiskScore: {
...
export interface PaymentServiceServer extends UntypedServiceImplementation {
  ...
  createJournalExport: handleUnaryCall<CreateJournalExportRequest, JournalExportResponse>;
  getJournalExportFormats: handleUnaryCall<CreateJournalExportRequest, GetJournalExportFormatsResponse>;
  /** ==================== RISK SCORING ==================== */
