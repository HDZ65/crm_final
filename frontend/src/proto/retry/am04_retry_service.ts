...
export const GetRetryPolicyRequest = {
  encode(message: GetRetryPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetryPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryPolicyResponse = {
  encode(message: RetryPolicyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.policy !== undefined) {
      RetryPolicy.encode(message.policy, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RetryPolicyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryPoliciesRequest = {
  encode(message: ListRetryPoliciesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryPoliciesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryPoliciesResponse = {
  encode(message: ListRetryPoliciesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.policies) {
      RetryPolicy.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryPoliciesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateRetryPolicyRequest = {
  encode(message: CreateRetryPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.societeId !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateRetryPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateRetryPolicyRequest = {
  encode(message: UpdateRetryPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateRetryPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UpdateRetryPolicyRequest {
    return {
      ...
      maxTotalDays: isSet(object.maxTotalDays) ? globalThis.Number(object.maxTotalDays) : undefined,
      retryOnAm04: isSet(object.retryOnAm04) ? globalThis.Boolean(object.retryOnAm04) : undefined,
      retryableCodes: globalThis.Array.isArray(object?.retryableCodes)
        ? object.retryableCodes.map((e: any) => rejectionReasonCodeFromJSON(e))
        : [],
      nonRetryableCodes: globalThis.Array.isArray(object?.nonRetryableCodes)
      ...
      stopOnMandateRevoked: isSet(object.stopOnMandateRevoked)
        ? globalThis.Boolean(object.stopOnMandateRevoked)
        : undefined,
      backoffStrategy: isSet(object.backoffStrategy) ? globalThis.String(object.backoffStrategy) : undefined,
...
export const DeleteRetryPolicyRequest = {
  encode(message: DeleteRetryPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeleteRetryPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRetryScheduleRequest = {
  encode(message: GetRetryScheduleRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetryScheduleRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryScheduleResponse = {
  encode(message: RetryScheduleResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.schedule !== undefined) {
      RetrySchedule.encode(message.schedule, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.attempts) {
      RetryAttempt.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.reminders) {
      Reminder.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RetryScheduleResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetrySchedulesRequest = {
  encode(message: ListRetrySchedulesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.societeId !== undefined) {
    ...
    if (message.fromDate !== undefined) {
      Timestamp.encode(toTimestamp(message.fromDate), writer.uint32(58).fork()).ldelim();
    }
    if (message.toDate !== undefined) {
      Timestamp.encode(toTimestamp(message.toDate), writer.uint32(66).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetrySchedulesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListRetrySchedulesRequest {
    return {
      ...
      isResolved: isSet(object.isResolved) ? globalThis.Boolean(object.isResolved) : undefined,
...
export const ListRetrySchedulesResponse = {
  encode(message: ListRetrySchedulesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.schedules) {
      RetrySchedule.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetrySchedulesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelRetryScheduleRequest = {
  encode(message: CancelRetryScheduleRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelRetryScheduleRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReplanRetryScheduleRequest = {
  encode(message: ReplanRetryScheduleRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.newRetryDate !== undefined) {
      Timestamp.encode(toTimestamp(message.newRetryDate), writer.uint32(18).fork()).ldelim();
    }
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReplanRetryScheduleRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ReplanRetryScheduleRequest {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      newRetryDate: isSet(object.newRetryDate) ? fromJsonTimestamp(object.newRetryDate) : undefined,
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
      replannedBy: isSet(object.replannedBy) ? globalThis.String(object.replannedBy) : "",
    };
  },
...
export const GetRetryAttemptRequest = {
  encode(message: GetRetryAttemptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetryAttemptRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryAttemptResponse = {
  encode(message: RetryAttemptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.attempt !== undefined) {
      RetryAttempt.encode(message.attempt, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RetryAttemptResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryAttemptsRequest = {
  encode(message: ListRetryAttemptsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryAttemptsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryAttemptsResponse = {
  encode(message: ListRetryAttemptsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.attempts) {
      RetryAttempt.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryAttemptsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RunNowRequest = {
  encode(message: RunNowRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RunNowRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RunNowResponse = {
  encode(message: RunNowResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.jobId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RunNowResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RunNowResponse {
    return {
      ...
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      scheduledCount: isSet(object.scheduledCount) ? globalThis.Number(object.scheduledCount) : 0,
    };
  },
...
export const GetRetryJobStatusRequest = {
  encode(message: GetRetryJobStatusRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.jobId !== "") {
      writer.uint32(10).string(message.jobId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetryJobStatusRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryJobResponse = {
  encode(message: RetryJobResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.job !== undefined) {
      RetryJob.encode(message.job, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RetryJobResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryJobsRequest = {
  encode(message: ListRetryJobsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryJobsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetryJobsResponse = {
  encode(message: ListRetryJobsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.jobs) {
      RetryJob.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetryJobsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRetryMetricsRequest = {
  encode(message: GetRetryMetricsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.societeId !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetryMetricsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryMetricsResponse = {
  encode(message: RetryMetricsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.rejectionCodeBreakdown) {
      RejectionCodeMetric.encode(v!, writer.uint32(122).fork()).ldelim();
    }
    for (const v of message.dailyMetrics) {
      DailyRetryMetric.encode(v!, writer.uint32(130).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RetryMetricsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13:
          ...
          message.totalAmountRecoveredCents = longToNumber(reader.int64() as Long);
          continue;
        case 14:
          if (tag !== 112) {
            break;
          ...
          message.totalAmountPendingCents = longToNumber(reader.int64() as Long);
          continue;
        case 15:
          if (tag !== 122) {
            break;
  ...
  fromJSON(object: any): RetryMetricsResponse {
    return {
      totalRejections: isSet(object.totalRejections) ? globalThis.Number(object.totalRejections) : 0,
      am04Rejections: isSet(object.am04Rejections) ? globalThis.Number(object.am04Rejections) : 0,
      otherRejections: isSet(object.otherRejections) ? globalThis.Number(object.otherRejections) : 0,
      totalRetrySchedules: isSet(object.totalRetrySchedules) ? globalThis.Number(object.totalRetrySchedules) : 0,
      eligibleForRetry: isSet(object.eligibleForRetry) ? globalThis.Number(object.eligibleForRetry) : 0,
      notEligible: isSet(object.notEligible) ? globalThis.Number(object.notEligible) : 0,
      totalRetryAttempts: isSet(object.totalRetryAttempts) ? globalThis.Number(object.totalRetryAttempts) : 0,
      successfulRetries: isSet(object.successfulRetries) ? globalThis.Number(object.successfulRetries) : 0,
      failedRetries: isSet(object.failedRetries) ? globalThis.Number(object.failedRetries) : 0,
      pendingRetries: isSet(object.pendingRetries) ? globalThis.Number(object.pendingRetries) : 0,
      successRate: isSet(object.successRate) ? globalThis.Number(object.successRate) : 0,
      am04Rate: isSet(object.am04Rate) ? globalThis.Number(object.am04Rate) : 0,
...
export const RejectionCodeMetric = {
  encode(message: RejectionCodeMetric, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.code !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RejectionCodeMetric {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RejectionCodeMetric {
    return {
      ...
      codeRaw: isSet(object.codeRaw) ? globalThis.String(object.codeRaw) : "",
...
export const DailyRetryMetric = {
  encode(message: DailyRetryMetric, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.date !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DailyRetryMetric {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DailyRetryMetric {
    return {
      ...
      retriesScheduled: isSet(object.retriesScheduled) ? globalThis.Number(object.retriesScheduled) : 0,
      retriesExecuted: isSet(object.retriesExecuted) ? globalThis.Number(object.retriesExecuted) : 0,
      retriesSucceeded: isSet(object.retriesSucceeded) ? globalThis.Number(object.retriesSucceeded) : 0,
      retriesFailed: isSet(object.retriesFailed) ? globalThis.Number(object.retriesFailed) : 0,
    };
  },
...
export const GetAuditLogsRequest = {
  encode(message: GetAuditLogsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.fromDate !== undefined) {
      Timestamp.encode(toTimestamp(message.fromDate), writer.uint32(42).fork()).ldelim();
    }
    if (message.toDate !== undefined) {
      Timestamp.encode(toTimestamp(message.toDate), writer.uint32(50).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
  ...
  fromJSON(object: any): GetAuditLogsRequest {
    return {
      organisationId: isSet(object.organisationId) ? globalThis.String(object.organisationId) : "",
      entityType: isSet(object.entityType) ? globalThis.String(object.entityType) : undefined,
...
export const AuditLogsResponse = {
  encode(message: AuditLogsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.logs) {
      RetryAuditLog.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AuditLogsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProcessDueRetriesRequest = {
  encode(message: ProcessDueRetriesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.targetDate !== undefined) {
      Timestamp.encode(toTimestamp(message.targetDate), writer.uint32(18).fork()).ldelim();
    }
    if (message.timezone !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessDueRetriesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProcessDueRetriesResponse = {
  encode(message: ProcessDueRetriesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.jobId !== "") {
      writer.uint32(10).string(message.jobId);
    }
    if (message.status !== 0) {
    ...
    for (const v of message.results) {
      ProcessedRetryResult.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessDueRetriesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ProcessDueRetriesResponse {
    return {
      jobId: isSet(object.jobId) ? globalThis.String(object.jobId) : "",
      status: isSet(object.status) ? retryJobStatusFromJSON(object.status) : 0,
      totalProcessed: isSet(object.totalProcessed) ? globalThis.Number(object.totalProcessed) : 0,
...
export const ProcessedRetryResult = {
  encode(message: ProcessedRetryResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.retryScheduleId !== "") {
      writer.uint32(10).string(message.retryScheduleId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessedRetryResult {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckEligibilityRequest = {
  encode(message: CheckEligibilityRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CheckEligibilityRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CheckEligibilityRequest {
    return {
      ...
      rejectionCode: isSet(object.rejectionCode) ? globalThis.String(object.rejectionCode) : "",
      organisationId: isSet(object.organisationId) ? globalThis.String(object.organisationId) : "",
      societeId: isSet(object.societeId) ? globalThis.String(object.societeId) : undefined,
      contratId: isSet(object.contratId) ? globalThis.String(object.contratId) : undefined,
      clientId: isSet(object.clientId) ? globalThis.String(object.clientId) : undefined,
...
export const CheckEligibilityResponse = {
  encode(message: CheckEligibilityResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.firstRetryDate !== undefined) {
      Timestamp.encode(toTimestamp(message.firstRetryDate), writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CheckEligibilityResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CheckEligibilityResponse {
    return {
      ...
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
      applicablePolicyId: isSet(object.applicablePolicyId) ? globalThis.String(object.applicablePolicyId) : undefined,
      firstRetryDate: isSet(object.firstRetryDate) ? fromJsonTimestamp(object.firstRetryDate) : undefined,
    };
  },
...
export const HandleRejectionResponse = {
  encode(message: HandleRejectionResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): HandleRejectionResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetReminderPolicyRequest = {
  encode(message: GetReminderPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetReminderPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReminderPolicyResponse = {
  encode(message: ReminderPolicyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.policy !== undefined) {
      ReminderPolicy.encode(message.policy, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ReminderPolicyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListReminderPoliciesRequest = {
  encode(message: ListReminderPoliciesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.societeId !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListReminderPoliciesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListReminderPoliciesResponse = {
  encode(message: ListReminderPoliciesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.policies) {
      ReminderPolicy.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListReminderPoliciesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateReminderPolicyRequest = {
  encode(message: CreateReminderPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.societeId !== undefined) {
    ...
    for (const v of message.triggerRules) {
      ReminderTriggerRule.encode(v!, writer.uint32(42).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateReminderPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateReminderPolicyRequest = {
  encode(message: UpdateReminderPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.name !== undefined) {
    ...
    for (const v of message.triggerRules) {
      ReminderTriggerRule.encode(v!, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateReminderPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UpdateReminderPolicyRequest {
    return {
      ...
      triggerRules: globalThis.Array.isArray(object?.triggerRules)
        ? object.triggerRules.map((e: any) => ReminderTriggerRule.fromJSON(e))
        : [],
      cooldownHours: isSet(object.cooldownHours) ? globalThis.Number(object.cooldownHours) : undefined,
      maxRemindersPerDay: isSet(object.maxRemindersPerDay) ? globalThis.Number(object.maxRemindersPerDay) : undefined,
      maxRemindersPerWeek: isSet(object.maxRemindersPerWeek)
        ? globalThis.Number(object.maxRemindersPerWeek)
        : undefined,
      allowedStartHour: isSet(object.allowedStartHour) ? globalThis.Number(object.allowedStartHour) : undefined,
      allowedEndHour: isSet(object.allowedEndHour) ? globalThis.Number(object.allowedEndHour) : undefined,
      allowedDaysOfWeek: globalThis.Array.isArray(object?.allowedDaysOfWeek)
        ? object.allowedDaysOfWeek.map((e: any) => globalThis.Number(e))
        : [],
      respectOptOut: isSet(object.respectOptOut) ? globalThis.Boolean(object.respectOptOut) : undefined,
      isActive: isSet(object.isActive) ? globalThis.Boolean(object.isActive) : undefined,
      isDefault: isSet(object.isDefault) ? globalThis.Boolean(object.isDefault) : undefined,
      priority: isSet(object.priority) ? globalThis.Number(object.priority) : undefined,
    };
...
export const DeleteReminderPolicyRequest = {
  encode(message: DeleteReminderPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeleteReminderPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetReminderRequest = {
  encode(message: GetReminderRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetReminderRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReminderResponse = {
  encode(message: ReminderResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.reminder !== undefined) {
      Reminder.encode(message.reminder, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ReminderResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRemindersRequest = {
  encode(message: ListRemindersRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.retryScheduleId !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRemindersRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRemindersResponse = {
  encode(message: ListRemindersResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.reminders) {
      Reminder.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PaginationResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRemindersResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelReminderRequest = {
  encode(message: CancelReminderRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelReminderRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SendReminderRequest = {
  encode(message: SendReminderRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SendReminderRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SendReminderResponse = {
  encode(message: SendReminderResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SendReminderResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProcessDueRemindersRequest = {
  encode(message: ProcessDueRemindersRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.targetTime !== undefined) {
      Timestamp.encode(toTimestamp(message.targetTime), writer.uint32(18).fork()).ldelim();
    }
    if (message.timezone !== "") {
      writer.uint32(26).string(message.timezone);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessDueRemindersRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ProcessDueRemindersRequest {
    return {
      organisationId: isSet(object.organisationId) ? globalThis.String(object.organisationId) : "",
      targetTime: isSet(object.targetTime) ? fromJsonTimestamp(object.targetTime) : undefined,
      timezone: isSet(object.timezone) ? globalThis.String(object.timezone) : "",
      dryRun: isSet(object.dryRun) ? globalThis.Boolean(object.dryRun) : false,
    };
  },
...
export const ProcessDueRemindersResponse = {
  encode(message: ProcessDueRemindersResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.totalProcessed !== 0) {
    ...
    for (const v of message.results) {
      ProcessedReminderResult.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessDueRemindersResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProcessedReminderResult = {
  encode(message: ProcessedReminderResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProcessedReminderResult {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ProcessedReminderResult {
    return {
      ...
      errorCode: isSet(object.errorCode) ? globalThis.String(object.errorCode) : undefined,
      errorMessage: isSet(object.errorMessage) ? globalThis.String(object.errorMessage) : undefined,
      skipReason: isSet(object.skipReason) ? globalThis.String(object.skipReason) : undefined,
    };
  },
...
export const UpdateDeliveryStatusRequest = {
  encode(message: UpdateDeliveryStatusRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.reminderId !== "") {
      writer.uint32(10).string(message.reminderId);
    }
    if (message.status !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateDeliveryStatusRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryAdminServiceService = {
  getRetryPolicy: {
    ...
    requestSerialize: (value: GetRetryPolicyRequest) => Buffer.from(GetRetryPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetryPolicyRequest.decode(value),
    responseSerialize: (value: RetryPolicyResponse) => Buffer.from(RetryPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryPolicyResponse.decode(value),
  },
  listRetryPolicies: {
    path: "/retry.RetryAdminService/ListRetryPolicies",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRetryPoliciesRequest) => Buffer.from(ListRetryPoliciesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRetryPoliciesRequest.decode(value),
    responseSerialize: (value: ListRetryPoliciesResponse) =>
      Buffer.from(ListRetryPoliciesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRetryPoliciesResponse.decode(value),
  },
  createRetryPolicy: {
    path: "/retry.RetryAdminService/CreateRetryPolicy",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateRetryPolicyRequest) => Buffer.from(CreateRetryPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateRetryPolicyRequest.decode(value),
    responseSerialize: (value: RetryPolicyResponse) => Buffer.from(RetryPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryPolicyResponse.decode(value),
  },
  updateRetryPolicy: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateRetryPolicyRequest) => Buffer.from(UpdateRetryPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateRetryPolicyRequest.decode(value),
    responseSerialize: (value: RetryPolicyResponse) => Buffer.from(RetryPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryPolicyResponse.decode(value),
  },
  deleteRetryPolicy: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteRetryPolicyRequest) => Buffer.from(DeleteRetryPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteRetryPolicyRequest.decode(value),
  ...
  getRetrySchedule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetRetryScheduleRequest) => Buffer.from(GetRetryScheduleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetryScheduleRequest.decode(value),
    responseSerialize: (value: RetryScheduleResponse) => Buffer.from(RetryScheduleResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryScheduleResponse.decode(value),
  },
  listRetrySchedules: {
    path: "/retry.RetryAdminService/ListRetrySchedules",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRetrySchedulesRequest) =>
      Buffer.from(ListRetrySchedulesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRetrySchedulesRequest.decode(value),
    responseSerialize: (value: ListRetrySchedulesResponse) =>
      Buffer.from(ListRetrySchedulesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRetrySchedulesResponse.decode(value),
  },
  cancelRetrySchedule: {
    path: "/retry.RetryAdminService/CancelRetrySchedule",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelRetryScheduleRequest) =>
      Buffer.from(CancelRetryScheduleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CancelRetryScheduleRequest.decode(value),
    responseSerialize: (value: RetryScheduleResponse) => Buffer.from(RetryScheduleResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryScheduleResponse.decode(value),
  },
  replanRetrySchedule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ReplanRetryScheduleRequest) =>
      Buffer.from(ReplanRetryScheduleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ReplanRetryScheduleRequest.decode(value),
    responseSerialize: (value: RetryScheduleResponse) => Buffer.from(RetryScheduleResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryScheduleResponse.decode(value),
  },
  getRetryAttempt: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetRetryAttemptRequest) => Buffer.from(GetRetryAttemptRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetryAttemptRequest.decode(value),
    responseSerialize: (value: RetryAttemptResponse) => Buffer.from(RetryAttemptResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryAttemptResponse.decode(value),
  },
  listRetryAttempts: {
    path: "/retry.RetryAdminService/ListRetryAttempts",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRetryAttemptsRequest) => Buffer.from(ListRetryAttemptsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRetryAttemptsRequest.decode(value),
    responseSerialize: (value: ListRetryAttemptsResponse) =>
      Buffer.from(ListRetryAttemptsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRetryAttemptsResponse.decode(value),
  },
  runNow: {
    path: "/retry.RetryAdminService/RunNow",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RunNowRequest) => Buffer.from(RunNowRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RunNowRequest.decode(value),
    responseSerialize: (value: RunNowResponse) => Buffer.from(RunNowResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RunNowResponse.decode(value),
  },
  getRetryJobStatus: {
    path: "/retry.RetryAdminService/GetRetryJobStatus",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetRetryJobStatusRequest) => Buffer.from(GetRetryJobStatusRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetryJobStatusRequest.decode(value),
    responseSerialize: (value: RetryJobResponse) => Buffer.from(RetryJobResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryJobResponse.decode(value),
  },
  listRetryJobs: {
    path: "/retry.RetryAdminService/ListRetryJobs",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRetryJobsRequest) => Buffer.from(ListRetryJobsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRetryJobsRequest.decode(value),
    responseSerialize: (value: ListRetryJobsResponse) => Buffer.from(ListRetryJobsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRetryJobsResponse.decode(value),
  },
  getRetryMetrics: {
    path: "/retry.RetryAdminService/GetRetryMetrics",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetRetryMetricsRequest) => Buffer.from(GetRetryMetricsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetryMetricsRequest.decode(value),
    responseSerialize: (value: RetryMetricsResponse) => Buffer.from(RetryMetricsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RetryMetricsResponse.decode(value),
  },
  getAuditLogs: {
    ...
    responseSerialize: (value: AuditLogsResponse) => Buffer.from(AuditLogsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AuditLogsResponse.decode(value),
  },
} as const;
...
export interface RetryAdminServiceClient extends Client {
  getRetryPolicy(
    request: GetRetryPolicyRequest,
    callback: (error: ServiceError | null, response: RetryPolicyResponse) => void,
  ): ClientUnaryCall;
  getRetryPolicy(
    request: GetRetryPolicyRequest,
    metadata: Metadata,
  ...
  listRetryPolicies(
    ...
    callback: (error: ServiceError | null, response: ListRetryPoliciesResponse) => void,
  ): ClientUnaryCall;
  listRetryPolicies(
    request: ListRetryPoliciesRequest,
    metadata: Metadata,
  ...
  getRetrySchedule(
    ...
    callback: (error: ServiceError | null, response: RetryScheduleResponse) => void,
  ): ClientUnaryCall;
  getRetrySchedule(
    request: GetRetryScheduleRequest,
    metadata: Metadata,
  ...
  listRetrySchedules(
    ...
    callback: (error: ServiceError | null, response: ListRetrySchedulesResponse) => void,
  ): ClientUnaryCall;
  listRetrySchedules(
    request: ListRetrySchedulesRequest,
    metadata: Metadata,
  ...
  getRetryAttempt(
    ...
    callback: (error: ServiceError | null, response: RetryAttemptResponse) => void,
  ): ClientUnaryCall;
  getRetryAttempt(
    request: GetRetryAttemptRequest,
    metadata: Metadata,
  ...
  listRetryAttempts(
    ...
    callback: (error: ServiceError | null, response: ListRetryAttemptsResponse) => void,
  ): ClientUnaryCall;
  listRetryAttempts(
    request: ListRetryAttemptsRequest,
    metadata: Metadata,
  ...
  runNow(
    ...
    callback: (error: ServiceError | null, response: RunNowResponse) => void,
  ): ClientUnaryCall;
  runNow(
    request: RunNowRequest,
    metadata: Metadata,
  ...
  getRetryJobStatus(
    ...
    callback: (error: ServiceError | null, response: RetryJobResponse) => void,
  ): ClientUnaryCall;
  getRetryJobStatus(
    request: GetRetryJobStatusRequest,
    metadata: Metadata,
  ...
  listRetryJobs(
    ...
    callback: (error: ServiceError | null, response: ListRetryJobsResponse) => void,
  ): ClientUnaryCall;
  listRetryJobs(
    request: ListRetryJobsRequest,
    metadata: Metadata,
  ...
  getRetryMetrics(
    ...
    callback: (error: ServiceError | null, response: RetryMetricsResponse) => void,
  ): ClientUnaryCall;
  getRetryMetrics(
    request: GetRetryMetricsRequest,
    metadata: Metadata,
  ...
  getAuditLogs(
    ...
    callback: (error: ServiceError | null, response: AuditLogsResponse) => void,
  ): ClientUnaryCall;
  getAuditLogs(
    request: GetAuditLogsRequest,
    metadata: Metadata,
...
export const RetryAdminServiceClient = makeGenericClientConstructor(
  RetryAdminServiceService,
  "retry.RetryAdminService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): RetryAdminServiceClient;
  service: typeof RetryAdminServiceService;
  serviceName: string;
};
...
export const RetrySchedulerServiceService = {
  processDueRetries: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ProcessDueRetriesRequest) => Buffer.from(ProcessDueRetriesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProcessDueRetriesRequest.decode(value),
    responseSerialize: (value: ProcessDueRetriesResponse) =>
      Buffer.from(ProcessDueRetriesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ProcessDueRetriesResponse.decode(value),
  },
  checkEligibility: {
    path: "/retry.RetrySchedulerService/CheckEligibility",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CheckEligibilityRequest) => Buffer.from(CheckEligibilityRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CheckEligibilityRequest.decode(value),
    responseSerialize: (value: CheckEligibilityResponse) =>
      Buffer.from(CheckEligibilityResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CheckEligibilityResponse.decode(value),
  },
  handlePaymentRejected: {
    path: "/retry.RetrySchedulerService/HandlePaymentRejected",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: PaymentRejectedEvent) => Buffer.from(PaymentRejectedEvent.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PaymentRejectedEvent.decode(value),
    responseSerialize: (value: HandleRejectionResponse) => Buffer.from(HandleRejectionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => HandleRejectionResponse.decode(value),
  },
} as const;
...
export interface RetrySchedulerServiceClient extends Client {
  processDueRetries(
    request: ProcessDueRetriesRequest,
    callback: (error: ServiceError | null, response: ProcessDueRetriesResponse) => void,
  ): ClientUnaryCall;
  processDueRetries(
    request: ProcessDueRetriesRequest,
    metadata: Metadata,
  ...
  checkEligibility(
    ...
    callback: (error: ServiceError | null, response: CheckEligibilityResponse) => void,
  ): ClientUnaryCall;
  checkEligibility(
    request: CheckEligibilityRequest,
    metadata: Metadata,
  ...
  handlePaymentRejected(
    ...
    callback: (error: ServiceError | null, response: HandleRejectionResponse) => void,
  ): ClientUnaryCall;
  handlePaymentRejected(
    request: PaymentRejectedEvent,
    metadata: Metadata,
...
export const RetrySchedulerServiceClient = makeGenericClientConstructor(
  RetrySchedulerServiceService,
  "retry.RetrySchedulerService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): RetrySchedulerServiceClient;
  service: typeof RetrySchedulerServiceService;
  serviceName: string;
};
...
export const ReminderServiceService = {
  getReminderPolicy: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetReminderPolicyRequest) => Buffer.from(GetReminderPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetReminderPolicyRequest.decode(value),
    responseSerialize: (value: ReminderPolicyResponse) => Buffer.from(ReminderPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderPolicyResponse.decode(value),
  },
  listReminderPolicies: {
    path: "/retry.ReminderService/ListReminderPolicies",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListReminderPoliciesRequest) =>
      Buffer.from(ListReminderPoliciesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListReminderPoliciesRequest.decode(value),
    responseSerialize: (value: ListReminderPoliciesResponse) =>
      Buffer.from(ListReminderPoliciesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListReminderPoliciesResponse.decode(value),
  },
  createReminderPolicy: {
    path: "/retry.ReminderService/CreateReminderPolicy",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateReminderPolicyRequest) =>
      Buffer.from(CreateReminderPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateReminderPolicyRequest.decode(value),
    responseSerialize: (value: ReminderPolicyResponse) => Buffer.from(ReminderPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderPolicyResponse.decode(value),
  },
  updateReminderPolicy: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateReminderPolicyRequest) =>
      Buffer.from(UpdateReminderPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateReminderPolicyRequest.decode(value),
    responseSerialize: (value: ReminderPolicyResponse) => Buffer.from(ReminderPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderPolicyResponse.decode(value),
  },
  deleteReminderPolicy: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteReminderPolicyRequest) =>
      Buffer.from(DeleteReminderPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteReminderPolicyRequest.decode(value),
    responseSerialize: (value: DeleteResponse) => Buffer.from(DeleteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DeleteResponse.decode(value),
  },
  getReminder: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetReminderRequest) => Buffer.from(GetReminderRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetReminderRequest.decode(value),
    responseSerialize: (value: ReminderResponse) => Buffer.from(ReminderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderResponse.decode(value),
  },
  listReminders: {
    path: "/retry.ReminderService/ListReminders",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRemindersRequest) => Buffer.from(ListRemindersRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRemindersRequest.decode(value),
    responseSerialize: (value: ListRemindersResponse) => Buffer.from(ListRemindersResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRemindersResponse.decode(value),
  },
  cancelReminder: {
    path: "/retry.ReminderService/CancelReminder",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelReminderRequest) => Buffer.from(CancelReminderRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CancelReminderRequest.decode(value),
    responseSerialize: (value: ReminderResponse) => Buffer.from(ReminderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderResponse.decode(value),
  },
  sendReminder: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendReminderRequest) => Buffer.from(SendReminderRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SendReminderRequest.decode(value),
    responseSerialize: (value: SendReminderResponse) => Buffer.from(SendReminderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SendReminderResponse.decode(value),
  },
  processDueReminders: {
    path: "/retry.ReminderService/ProcessDueReminders",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ProcessDueRemindersRequest) =>
      Buffer.from(ProcessDueRemindersRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProcessDueRemindersRequest.decode(value),
    responseSerialize: (value: ProcessDueRemindersResponse) =>
      Buffer.from(ProcessDueRemindersResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ProcessDueRemindersResponse.decode(value),
  },
  updateDeliveryStatus: {
    path: "/retry.ReminderService/UpdateDeliveryStatus",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateDeliveryStatusRequest) =>
      Buffer.from(UpdateDeliveryStatusRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateDeliveryStatusRequest.decode(value),
    responseSerialize: (value: ReminderResponse) => Buffer.from(ReminderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReminderResponse.decode(value),
  },
} as const;
...
export interface ReminderServiceClient extends Client {
  getReminderPolicy(
    request: GetReminderPolicyRequest,
    callback: (error: ServiceError | null, response: ReminderPolicyResponse) => void,
  ): ClientUnaryCall;
  getReminderPolicy(
    request: GetReminderPolicyRequest,
    metadata: Metadata,
  ...
  listReminderPolicies(
    ...
    callback: (error: ServiceError | null, response: ListReminderPoliciesResponse) => void,
  ): ClientUnaryCall;
  listReminderPolicies(
    request: ListReminderPoliciesRequest,
    metadata: Metadata,
  ...
  getReminder(
    ...
    callback: (error: ServiceError | null, response: ReminderResponse) => void,
  ): ClientUnaryCall;
  getReminder(
    request: GetReminderRequest,
    metadata: Metadata,
  ...
  listReminders(
    ...
    callback: (error: ServiceError | null, response: ListRemindersResponse) => void,
  ): ClientUnaryCall;
  listReminders(
    request: ListRemindersRequest,
    metadata: Metadata,
  ...
  sendReminder(
    ...
    callback: (error: ServiceError | null, response: SendReminderResponse) => void,
  ): ClientUnaryCall;
  sendReminder(
    request: SendReminderRequest,
    metadata: Metadata,
  ...
  processDueReminders(
    ...
    callback: (error: ServiceError | null, response: ProcessDueRemindersResponse) => void,
  ): ClientUnaryCall;
  processDueReminders(
    request: ProcessDueRemindersRequest,
    metadata: Metadata,
...
export const ReminderServiceClient = makeGenericClientConstructor(
  ReminderServiceService,
  "retry.ReminderService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): ReminderServiceClient;
  service: typeof ReminderServiceService;
  serviceName: string;
};
