...
export function blindIndexTypeFromJSON(object: any): BlindIndexType {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return BlindIndexType.UNRECOGNIZED;
  }
}
...
export function blindIndexTypeToJSON(object: BlindIndexType): string {
  switch (object) {
    ...
    case BlindIndexType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const DataKey = {
  encode(message: DataKey, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
    ...
    if (message.activatedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.activatedAt), writer.uint32(66).fork()).ldelim();
    }
    if (message.deprecatedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.deprecatedAt), writer.uint32(74).fork()).ldelim();
    }
    if (message.scheduledDeletionAt !== undefined) {
      Timestamp.encode(toTimestamp(message.scheduledDeletionAt), writer.uint32(82).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DataKey {
  ...
  fromJSON(object: any): DataKey {
    return {
      ...
      activatedAt: isSet(object.activatedAt) ? fromJsonTimestamp(object.activatedAt) : undefined,
      deprecatedAt: isSet(object.deprecatedAt) ? fromJsonTimestamp(object.deprecatedAt) : undefined,
...
export const EncryptedFieldMeta = {
  encode(message: EncryptedFieldMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.encryptedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.encryptedAt), writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): EncryptedFieldMeta {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): EncryptedFieldMeta {
    return {
      keyVersion: isSet(object.keyVersion) ? globalThis.Number(object.keyVersion) : 0,
      domain: isSet(object.domain) ? keyDomainFromJSON(object.domain) : 0,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : "",
      nonce: isSet(object.nonce) ? bytesFromBase64(object.nonce) : new Uint8Array(0),
      aad: isSet(object.aad) ? bytesFromBase64(object.aad) : new Uint8Array(0),
      encryptedAt: isSet(object.encryptedAt) ? fromJsonTimestamp(object.encryptedAt) : undefined,
    };
  },
...
export const EncryptResponse = {
  encode(message: EncryptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.meta !== undefined) {
      EncryptedFieldMeta.encode(message.meta, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
...
export const BatchEncryptRequest = {
  encode(message: BatchEncryptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchEncryptRequest_Item.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.domain !== 0) {
      writer.uint32(16).int32(message.domain);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchEncryptRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchEncryptRequest_Item = {
  encode(message: BatchEncryptRequest_Item, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.plaintext.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchEncryptRequest_Item {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchEncryptResponse = {
  encode(message: BatchEncryptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchEncryptResponse_EncryptedItem.encode(v!, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchEncryptResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchEncryptResponse_EncryptedItem = {
  encode(message: BatchEncryptResponse_EncryptedItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.ciphertext.length !== 0) {
    ...
    if (message.meta !== undefined) {
      EncryptedFieldMeta.encode(message.meta, writer.uint32(26).fork()).ldelim();
    }
    if (message.error !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchEncryptResponse_EncryptedItem {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchDecryptRequest = {
  encode(message: BatchDecryptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchDecryptRequest_Item.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.context !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchDecryptRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchDecryptRequest_Item = {
  encode(message: BatchDecryptRequest_Item, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.ciphertext.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchDecryptRequest_Item {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchDecryptResponse = {
  encode(message: BatchDecryptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchDecryptResponse_DecryptedItem.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.successCount !== 0) {
      writer.uint32(16).int32(message.successCount);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchDecryptResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchDecryptResponse_DecryptedItem = {
  encode(message: BatchDecryptResponse_DecryptedItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.plaintext.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchDecryptResponse_DecryptedItem {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReencryptRequest = {
  encode(message: ReencryptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ciphertext.length !== 0) {
      writer.uint32(10).bytes(message.ciphertext);
    }
    if (message.currentMeta !== undefined) {
      EncryptedFieldMeta.encode(message.currentMeta, writer.uint32(18).fork()).ldelim();
    }
    if (message.context !== "") {
      writer.uint32(26).string(message.context);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReencryptRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ReencryptRequest {
    return {
      ciphertext: isSet(object.ciphertext) ? bytesFromBase64(object.ciphertext) : new Uint8Array(0),
      currentMeta: isSet(object.currentMeta) ? EncryptedFieldMeta.fromJSON(object.currentMeta) : undefined,
      context: isSet(object.context) ? globalThis.String(object.context) : "",
    };
  },
...
export const ReencryptResponse = {
  encode(message: ReencryptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ciphertext.length !== 0) {
      writer.uint32(10).bytes(message.ciphertext);
    }
    if (message.newMeta !== undefined) {
      EncryptedFieldMeta.encode(message.newMeta, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReencryptResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ReencryptResponse {
    return {
      ciphertext: isSet(object.ciphertext) ? bytesFromBase64(object.ciphertext) : new Uint8Array(0),
      newMeta: isSet(object.newMeta) ? EncryptedFieldMeta.fromJSON(object.newMeta) : undefined,
      keyVersionChanged: isSet(object.keyVersionChanged) ? globalThis.Boolean(object.keyVersionChanged) : false,
    };
  },
...
export const GenerateBlindIndexRequest = {
  encode(message: GenerateBlindIndexRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GenerateBlindIndexRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GenerateBlindIndexRequest {
    return {
      ...
      indexType: isSet(object.indexType) ? blindIndexTypeFromJSON(object.indexType) : 0,
      domain: isSet(object.domain) ? keyDomainFromJSON(object.domain) : 0,
    };
  },
...
export const GenerateBlindIndexResponse = {
  encode(message: GenerateBlindIndexResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GenerateBlindIndexResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GenerateBlindIndexResponse {
    return {
      blindIndex: isSet(object.blindIndex) ? bytesFromBase64(object.blindIndex) : new Uint8Array(0),
      keyVersion: isSet(object.keyVersion) ? globalThis.Number(object.keyVersion) : 0,
    };
  },
...
export const BatchGenerateBlindIndexRequest = {
  encode(message: BatchGenerateBlindIndexRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchGenerateBlindIndexRequest_Item.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.indexType !== 0) {
      writer.uint32(16).int32(message.indexType);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchGenerateBlindIndexRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchGenerateBlindIndexRequest_Item = {
  encode(message: BatchGenerateBlindIndexRequest_Item, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchGenerateBlindIndexRequest_Item {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchGenerateBlindIndexResponse = {
  encode(message: BatchGenerateBlindIndexResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
      BatchGenerateBlindIndexResponse_IndexedItem.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.keyVersion !== 0) {
      writer.uint32(16).int32(message.keyVersion);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchGenerateBlindIndexResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BatchGenerateBlindIndexResponse_IndexedItem = {
  encode(message: BatchGenerateBlindIndexResponse_IndexedItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.blindIndex.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BatchGenerateBlindIndexResponse_IndexedItem {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListKeysRequest = {
  ...
  fromJSON(object: any): ListKeysRequest {
    return {
      domain: isSet(object.domain) ? keyDomainFromJSON(object.domain) : 0,
      environment: isSet(object.environment) ? globalThis.String(object.environment) : "",
      includeDeprecated: isSet(object.includeDeprecated) ? globalThis.Boolean(object.includeDeprecated) : false,
    };
  },
...
export const ListKeysResponse = {
  encode(message: ListKeysResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.keys) {
      DataKey.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
...
export const GetCurrentKeyRequest = {
  encode(message: GetCurrentKeyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.domain !== 0) {
      writer.uint32(8).int32(message.domain);
    }
    if (message.environment !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetCurrentKeyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetCurrentKeyResponse = {
  encode(message: GetCurrentKeyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== undefined) {
      DataKey.encode(message.key, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GetCurrentKeyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RotateKeyResponse = {
  encode(message: RotateKeyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.newKey !== undefined) {
      DataKey.encode(message.newKey, writer.uint32(10).fork()).ldelim();
    }
    if (message.oldKey !== undefined) {
      DataKey.encode(message.oldKey, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): RotateKeyResponse {
    return {
      newKey: isSet(object.newKey) ? DataKey.fromJSON(object.newKey) : undefined,
      oldKey: isSet(object.oldKey) ? DataKey.fromJSON(object.oldKey) : undefined,
    };
  },
...
export const ScheduleKeyDeletionRequest = {
  encode(message: ScheduleKeyDeletionRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.keyId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ScheduleKeyDeletionRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ScheduleKeyDeletionRequest {
    return {
      ...
      pendingDays: isSet(object.pendingDays) ? globalThis.Number(object.pendingDays) : 0,
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
    };
  },
...
export const ScheduleKeyDeletionResponse = {
  encode(message: ScheduleKeyDeletionResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== undefined) {
      DataKey.encode(message.key, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ScheduleKeyDeletionResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelKeyDeletionRequest = {
  encode(message: CancelKeyDeletionRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.keyId !== "") {
      writer.uint32(10).string(message.keyId);
    }
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelKeyDeletionRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelKeyDeletionResponse = {
  encode(message: CancelKeyDeletionResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== undefined) {
      DataKey.encode(message.key, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelKeyDeletionResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CryptoServiceService = {
  ...
  batchEncrypt: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: BatchEncryptRequest) => Buffer.from(BatchEncryptRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => BatchEncryptRequest.decode(value),
    responseSerialize: (value: BatchEncryptResponse) => Buffer.from(BatchEncryptResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => BatchEncryptResponse.decode(value),
  },
  batchDecrypt: {
    path: "/security.CryptoService/BatchDecrypt",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: BatchDecryptRequest) => Buffer.from(BatchDecryptRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => BatchDecryptRequest.decode(value),
    responseSerialize: (value: BatchDecryptResponse) => Buffer.from(BatchDecryptResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => BatchDecryptResponse.decode(value),
  },
  reencrypt: {
    path: "/security.CryptoService/Reencrypt",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ReencryptRequest) => Buffer.from(ReencryptRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ReencryptRequest.decode(value),
    responseSerialize: (value: ReencryptResponse) => Buffer.from(ReencryptResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ReencryptResponse.decode(value),
  },
  generateBlindIndex: {
    path: "/security.CryptoService/GenerateBlindIndex",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GenerateBlindIndexRequest) =>
      Buffer.from(GenerateBlindIndexRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GenerateBlindIndexRequest.decode(value),
    responseSerialize: (value: GenerateBlindIndexResponse) =>
      Buffer.from(GenerateBlindIndexResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GenerateBlindIndexResponse.decode(value),
  },
  batchGenerateBlindIndex: {
    path: "/security.CryptoService/BatchGenerateBlindIndex",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: BatchGenerateBlindIndexRequest) =>
      Buffer.from(BatchGenerateBlindIndexRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => BatchGenerateBlindIndexRequest.decode(value),
    responseSerialize: (value: BatchGenerateBlindIndexResponse) =>
      Buffer.from(BatchGenerateBlindIndexResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => BatchGenerateBlindIndexResponse.decode(value),
  },
  listKeys: {
  ...
  getCurrentKey: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetCurrentKeyRequest) => Buffer.from(GetCurrentKeyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetCurrentKeyRequest.decode(value),
    responseSerialize: (value: GetCurrentKeyResponse) => Buffer.from(GetCurrentKeyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetCurrentKeyResponse.decode(value),
  },
  rotateKey: {
    path: "/security.CryptoService/RotateKey",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RotateKeyRequest) => Buffer.from(RotateKeyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RotateKeyRequest.decode(value),
    responseSerialize: (value: RotateKeyResponse) => Buffer.from(RotateKeyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RotateKeyResponse.decode(value),
  },
  scheduleKeyDeletion: {
    path: "/security.CryptoService/ScheduleKeyDeletion",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ScheduleKeyDeletionRequest) =>
      Buffer.from(ScheduleKeyDeletionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ScheduleKeyDeletionRequest.decode(value),
    responseSerialize: (value: ScheduleKeyDeletionResponse) =>
      Buffer.from(ScheduleKeyDeletionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ScheduleKeyDeletionResponse.decode(value),
  },
  cancelKeyDeletion: {
    path: "/security.CryptoService/CancelKeyDeletion",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelKeyDeletionRequest) => Buffer.from(CancelKeyDeletionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CancelKeyDeletionRequest.decode(value),
    responseSerialize: (value: CancelKeyDeletionResponse) =>
      Buffer.from(CancelKeyDeletionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CancelKeyDeletionResponse.decode(value),
  },
  sign: {
  ...
  verify: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: VerifyRequest) => Buffer.from(VerifyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => VerifyRequest.decode(value),
    responseSerialize: (value: VerifyResponse) => Buffer.from(VerifyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => VerifyResponse.decode(value),
  },
} as const;
