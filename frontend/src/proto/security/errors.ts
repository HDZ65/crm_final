...
export const SecurityError = {
  encode(message: SecurityError, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.code !== 0) {
    ...
    Object.entries(message.details).forEach(([key, value]) => {
      SecurityError_DetailsEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).ldelim();
    });
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SecurityError {
  ...
  fromJSON(object: any): SecurityError {
    return {
      ...
      stepUpTtlSeconds: isSet(object.stepUpTtlSeconds) ? globalThis.Number(object.stepUpTtlSeconds) : 0,
      requiredPermission: isSet(object.requiredPermission) ? globalThis.String(object.requiredPermission) : "",
...
export const SecurityError_DetailsEntry = {
  encode(message: SecurityError_DetailsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SecurityError_DetailsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RateLimitError = {
  encode(message: RateLimitError, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RateLimitError {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.retryAfter = longToNumber(reader.int64() as Long);
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  fromJSON(object: any): RateLimitError {
    return {
      ...
      windowSeconds: isSet(object.windowSeconds) ? globalThis.Number(object.windowSeconds) : 0,
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
    };
  },
