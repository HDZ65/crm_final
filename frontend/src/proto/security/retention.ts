...
export const RetentionPolicy = {
  encode(message: RetentionPolicy, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RetentionPolicy {
  ...
  fromJSON(object: any): RetentionPolicy {
    return {
      ...
      purgeMode: isSet(object.purgeMode) ? purgeModeFromJSON(object.purgeMode) : 0,
      legalBasis: isSet(object.legalBasis) ? globalThis.String(object.legalBasis) : "",
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      createdAt: isSet(object.createdAt) ? fromJsonTimestamp(object.createdAt) : undefined,
      updatedAt: isSet(object.updatedAt) ? fromJsonTimestamp(object.updatedAt) : undefined,
      updatedByUserId: isSet(object.updatedByUserId) ? globalThis.String(object.updatedByUserId) : "",
...
export const UpsertRetentionPolicyRequest = {
  encode(message: UpsertRetentionPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.category !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpsertRetentionPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpsertRetentionPolicyResponse = {
  encode(message: UpsertRetentionPolicyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.policy !== undefined) {
      RetentionPolicy.encode(message.policy, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpsertRetentionPolicyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetentionPoliciesRequest = {
  encode(message: ListRetentionPoliciesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.serviceName !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetentionPoliciesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRetentionPoliciesResponse = {
  encode(message: ListRetentionPoliciesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.policies) {
      RetentionPolicy.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ListRetentionPoliciesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRetentionPolicyRequest = {
  encode(message: GetRetentionPolicyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetentionPolicyRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRetentionPolicyResponse = {
  encode(message: GetRetentionPolicyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.policy !== undefined) {
      RetentionPolicy.encode(message.policy, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetRetentionPolicyResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PurgeJob = {
  encode(message: PurgeJob, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.cutoffDate !== undefined) {
      Timestamp.encode(toTimestamp(message.cutoffDate), writer.uint32(42).fork()).ldelim();
    }
    if (message.status !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PurgeJob {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.recordsScanned = longToNumber(reader.int64() as Long);
          continue;
        case 8:
          if (tag !== 64) {
            break;
          ...
          message.recordsDeleted = longToNumber(reader.int64() as Long);
          continue;
        case 9:
          if (tag !== 72) {
            break;
          ...
          message.recordsAnonymized = longToNumber(reader.int64() as Long);
          continue;
        case 10:
          if (tag !== 80) {
            break;
          ...
          message.recordsArchived = longToNumber(reader.int64() as Long);
          continue;
        case 11:
          if (tag !== 88) {
            break;
          ...
          message.recordsRetained = longToNumber(reader.int64() as Long);
          continue;
        case 12:
          if (tag !== 98) {
            break;
  ...
  fromJSON(object: any): PurgeJob {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      retentionPolicyId: isSet(object.retentionPolicyId) ? globalThis.String(object.retentionPolicyId) : "",
      serviceName: isSet(object.serviceName) ? globalThis.String(object.serviceName) : "",
      entityName: isSet(object.entityName) ? globalThis.String(object.entityName) : "",
      cutoffDate: isSet(object.cutoffDate) ? fromJsonTimestamp(object.cutoffDate) : undefined,
      status: isSet(object.status) ? purgeExecutionStatusFromJSON(object.status) : 0,
      recordsScanned: isSet(object.recordsScanned) ? globalThis.Number(object.recordsScanned) : 0,
      recordsDeleted: isSet(object.recordsDeleted) ? globalThis.Number(object.recordsDeleted) : 0,
      recordsAnonymized: isSet(object.recordsAnonymized) ? globalThis.Number(object.recordsAnonymized) : 0,
      recordsArchived: isSet(object.recordsArchived) ? globalThis.Number(object.recordsArchived) : 0,
      recordsRetained: isSet(object.recordsRetained) ? globalThis.Number(object.recordsRetained) : 0,
      retentionReason: isSet(object.retentionReason) ? globalThis.String(object.retentionReason) : "",
...
export const RunScheduledPurgeRequest = {
  encode(message: RunScheduledPurgeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.serviceName !== "") {
      writer.uint32(10).string(message.serviceName);
    }
    if (message.category !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RunScheduledPurgeRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RunScheduledPurgeResponse = {
  encode(message: RunScheduledPurgeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.jobs) {
      PurgeJob.encode(v!, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RunScheduledPurgeResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.totalRecordsPurged = longToNumber(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RunScheduledPurgeResponse {
    return {
      ...
      totalJobs: isSet(object.totalJobs) ? globalThis.Number(object.totalJobs) : 0,
      successfulJobs: isSet(object.successfulJobs) ? globalThis.Number(object.successfulJobs) : 0,
      failedJobs: isSet(object.failedJobs) ? globalThis.Number(object.failedJobs) : 0,
      totalRecordsPurged: isSet(object.totalRecordsPurged) ? globalThis.Number(object.totalRecordsPurged) : 0,
    };
  },
...
export const ListPurgeJobsRequest = {
  encode(message: ListPurgeJobsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.serviceName !== "") {
      writer.uint32(10).string(message.serviceName);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPurgeJobsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPurgeJobsResponse = {
  encode(message: ListPurgeJobsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.jobs) {
      PurgeJob.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.total !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPurgeJobsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PurgeRequest = {
  encode(message: PurgeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.legalHoldUntil !== undefined) {
      Timestamp.encode(toTimestamp(message.legalHoldUntil), writer.uint32(90).fork()).ldelim();
    }
    if (message.status !== 0) {
    ...
    if (message.startedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.startedAt), writer.uint32(114).fork()).ldelim();
    }
    if (message.completedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.completedAt), writer.uint32(122).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PurgeRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PurgeRequest {
    return {
      ...
      requestedByUserId: isSet(object.requestedByUserId) ? globalThis.String(object.requestedByUserId) : "",
      subjectType: isSet(object.subjectType) ? subjectTypeFromJSON(object.subjectType) : 0,
      subjectId: isSet(object.subjectId) ? globalThis.String(object.subjectId) : "",
      subjectEmail: isSet(object.subjectEmail) ? globalThis.String(object.subjectEmail) : "",
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
      legalBasis: isSet(object.legalBasis) ? globalThis.String(object.legalBasis) : "",
      legalHold: isSet(object.legalHold) ? globalThis.Boolean(object.legalHold) : false,
      legalHoldReason: isSet(object.legalHoldReason) ? globalThis.String(object.legalHoldReason) : "",
      legalHoldUntil: isSet(object.legalHoldUntil) ? fromJsonTimestamp(object.legalHoldUntil) : undefined,
      status: isSet(object.status) ? purgeRequestStatusFromJSON(object.status) : 0,
      createdAt: isSet(object.createdAt) ? fromJsonTimestamp(object.createdAt) : undefined,
      startedAt: isSet(object.startedAt) ? fromJsonTimestamp(object.startedAt) : undefined,
      completedAt: isSet(object.completedAt) ? fromJsonTimestamp(object.completedAt) : undefined,
      externalReference: isSet(object.externalReference) ? globalThis.String(object.externalReference) : "",
    };
  },
...
export const PurgeExecution = {
  encode(message: PurgeExecution, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.executedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.executedAt), writer.uint32(98).fork()).ldelim();
    }
    if (message.errorMessage !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PurgeExecution {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.anonymizedCount = longToNumber(reader.int64() as Long);
          continue;
        case 8:
          if (tag !== 64) {
            break;
          ...
          message.retainedCount = longToNumber(reader.int64() as Long);
          continue;
        case 9:
          if (tag !== 74) {
            break;
  ...
  fromJSON(object: any): PurgeExecution {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      purgeRequestId: isSet(object.purgeRequestId) ? globalThis.String(object.purgeRequestId) : "",
      serviceName: isSet(object.serviceName) ? globalThis.String(object.serviceName) : "",
      entityName: isSet(object.entityName) ? globalThis.String(object.entityName) : "",
      status: isSet(object.status) ? purgeExecutionStatusFromJSON(object.status) : 0,
      deletedCount: isSet(object.deletedCount) ? globalThis.Number(object.deletedCount) : 0,
      anonymizedCount: isSet(object.anonymizedCount) ? globalThis.Number(object.anonymizedCount) : 0,
      retainedCount: isSet(object.retainedCount) ? globalThis.Number(object.retainedCount) : 0,
      retainedReason: isSet(object.retainedReason) ? globalThis.String(object.retainedReason) : "",
      verificationQuery: isSet(object.verificationQuery) ? globalThis.String(object.verificationQuery) : "",
      verificationPassed: isSet(object.verificationPassed) ? globalThis.Boolean(object.verificationPassed) : false,
...
export const CreatePurgeRequestRequest = {
  encode(message: CreatePurgeRequestRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreatePurgeRequestRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreatePurgeRequestResponse = {
  encode(message: CreatePurgeRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      PurgeRequest.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CreatePurgeRequestResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExecutePurgeRequest = {
  encode(message: ExecutePurgeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.purgeRequestId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExecutePurgeRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExecutePurgeResponse = {
  encode(message: ExecutePurgeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      PurgeRequest.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.executions) {
      PurgeExecution.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ExecutePurgeResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPurgeRequestRequest = {
  encode(message: GetPurgeRequestRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.purgeRequestId !== "") {
      writer.uint32(10).string(message.purgeRequestId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetPurgeRequestRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GetPurgeRequestRequest {
    return { purgeRequestId: isSet(object.purgeRequestId) ? globalThis.String(object.purgeRequestId) : "" };
  },
...
export const GetPurgeRequestResponse = {
  encode(message: GetPurgeRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      PurgeRequest.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.executions) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetPurgeRequestResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPurgeRequestsRequest = {
  encode(message: ListPurgeRequestsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPurgeRequestsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPurgeRequestsResponse = {
  encode(message: ListPurgeRequestsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.requests) {
      PurgeRequest.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.total !== 0) {
      writer.uint32(16).int32(message.total);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPurgeRequestsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelPurgeRequestRequest = {
  encode(message: CancelPurgeRequestRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.purgeRequestId !== "") {
      writer.uint32(10).string(message.purgeRequestId);
    }
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelPurgeRequestRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CancelPurgeRequestResponse = {
  encode(message: CancelPurgeRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      PurgeRequest.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CancelPurgeRequestResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LegalHold = {
  encode(message: LegalHold, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.organisationId !== "") {
    ...
    if (message.placedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.placedAt), writer.uint32(66).fork()).ldelim();
    }
    ...
    if (message.liftedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.liftedAt), writer.uint32(98).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LegalHold {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): LegalHold {
    return {
      ...
      subjectId: isSet(object.subjectId) ? globalThis.String(object.subjectId) : "",
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
      caseReference: isSet(object.caseReference) ? globalThis.String(object.caseReference) : "",
      placedByUserId: isSet(object.placedByUserId) ? globalThis.String(object.placedByUserId) : "",
      placedAt: isSet(object.placedAt) ? fromJsonTimestamp(object.placedAt) : undefined,
      expiresAt: isSet(object.expiresAt) ? fromJsonTimestamp(object.expiresAt) : undefined,
      isActive: isSet(object.isActive) ? globalThis.Boolean(object.isActive) : false,
      liftedByUserId: isSet(object.liftedByUserId) ? globalThis.String(object.liftedByUserId) : "",
      liftedAt: isSet(object.liftedAt) ? fromJsonTimestamp(object.liftedAt) : undefined,
...
export const PlaceLegalHoldRequest = {
  encode(message: PlaceLegalHoldRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.subjectType !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlaceLegalHoldRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlaceLegalHoldResponse = {
  encode(message: PlaceLegalHoldResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hold !== undefined) {
      LegalHold.encode(message.hold, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PlaceLegalHoldResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LiftLegalHoldRequest = {
  encode(message: LiftLegalHoldRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.holdId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LiftLegalHoldRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): LiftLegalHoldRequest {
    return {
      holdId: isSet(object.holdId) ? globalThis.String(object.holdId) : "",
      reason: isSet(object.reason) ? globalThis.String(object.reason) : "",
    };
  },
...
export const LiftLegalHoldResponse = {
  encode(message: LiftLegalHoldResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hold !== undefined) {
      LegalHold.encode(message.hold, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LiftLegalHoldResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckLegalHoldRequest = {
  encode(message: CheckLegalHoldRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.organisationId !== "") {
      writer.uint32(10).string(message.organisationId);
    }
    if (message.subjectType !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CheckLegalHoldRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckLegalHoldResponse = {
  encode(message: CheckLegalHoldResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hasHold !== false) {
      writer.uint32(8).bool(message.hasHold);
    }
    for (const v of message.activeHolds) {
      LegalHold.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CheckLegalHoldResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CheckLegalHoldResponse {
    return {
      hasHold: isSet(object.hasHold) ? globalThis.Boolean(object.hasHold) : false,
...
export const PurgeProof = {
  encode(message: PurgeProof, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.purgeRequestId !== "") {
      writer.uint32(10).string(message.purgeRequestId);
    }
    if (message.purgeCompletedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.purgeCompletedAt), writer.uint32(18).fork()).ldelim();
    }
    if (message.finalStatus !== 0) {
      writer.uint32(24).int32(message.finalStatus);
    }
    for (const v of message.executions) {
      PurgeExecution.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    ...
    if (message.proofGeneratedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.proofGeneratedAt), writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PurgeProof {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.totalDeleted = longToNumber(reader.int64() as Long);
          continue;
        case 6:
          if (tag !== 48) {
            break;
          ...
          message.totalAnonymized = longToNumber(reader.int64() as Long);
          continue;
        case 7:
          if (tag !== 56) {
            break;
          ...
          message.totalRetained = longToNumber(reader.int64() as Long);
          continue;
        case 8:
          if (tag !== 64) {
            break;
  ...
  fromJSON(object: any): PurgeProof {
    return {
      purgeRequestId: isSet(object.purgeRequestId) ? globalThis.String(object.purgeRequestId) : "",
      purgeCompletedAt: isSet(object.purgeCompletedAt) ? fromJsonTimestamp(object.purgeCompletedAt) : undefined,
      finalStatus: isSet(object.finalStatus) ? purgeRequestStatusFromJSON(object.finalStatus) : 0,
      executions: globalThis.Array.isArray(object?.executions)
        ? object.executions.map((e: any) => PurgeExecution.fromJSON(e))
        : [],
      totalDeleted: isSet(object.totalDeleted) ? globalThis.Number(object.totalDeleted) : 0,
      totalAnonymized: isSet(object.totalAnonymized) ? globalThis.Number(object.totalAnonymized) : 0,
      totalRetained: isSet(object.totalRetained) ? globalThis.Number(object.totalRetained) : 0,
      ...
      proofGeneratedAt: isSet(object.proofGeneratedAt) ? fromJsonTimestamp(object.proofGeneratedAt) : undefined,
    };
  },
...
export const GeneratePurgeProofRequest = {
  encode(message: GeneratePurgeProofRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.purgeRequestId !== "") {
      writer.uint32(10).string(message.purgeRequestId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GeneratePurgeProofRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GeneratePurgeProofResponse = {
  encode(message: GeneratePurgeProofResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.proof !== undefined) {
      PurgeProof.encode(message.proof, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GeneratePurgeProofResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ComplianceServiceService = {
  upsertRetentionPolicy: {
    ...
    requestSerialize: (value: UpsertRetentionPolicyRequest) =>
      Buffer.from(UpsertRetentionPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpsertRetentionPolicyRequest.decode(value),
    responseSerialize: (value: UpsertRetentionPolicyResponse) =>
      Buffer.from(UpsertRetentionPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UpsertRetentionPolicyResponse.decode(value),
  },
  listRetentionPolicies: {
    path: "/security.ComplianceService/ListRetentionPolicies",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRetentionPoliciesRequest) =>
      Buffer.from(ListRetentionPoliciesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRetentionPoliciesRequest.decode(value),
    responseSerialize: (value: ListRetentionPoliciesResponse) =>
      Buffer.from(ListRetentionPoliciesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRetentionPoliciesResponse.decode(value),
  },
  getRetentionPolicy: {
    path: "/security.ComplianceService/GetRetentionPolicy",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetRetentionPolicyRequest) =>
      Buffer.from(GetRetentionPolicyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetRetentionPolicyRequest.decode(value),
    responseSerialize: (value: GetRetentionPolicyResponse) =>
      Buffer.from(GetRetentionPolicyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetRetentionPolicyResponse.decode(value),
  },
  runScheduledPurge: {
    path: "/security.ComplianceService/RunScheduledPurge",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RunScheduledPurgeRequest) => Buffer.from(RunScheduledPurgeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RunScheduledPurgeRequest.decode(value),
    responseSerialize: (value: RunScheduledPurgeResponse) =>
      Buffer.from(RunScheduledPurgeResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RunScheduledPurgeResponse.decode(value),
  },
  listPurgeJobs: {
    path: "/security.ComplianceService/ListPurgeJobs",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListPurgeJobsRequest) => Buffer.from(ListPurgeJobsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListPurgeJobsRequest.decode(value),
    responseSerialize: (value: ListPurgeJobsResponse) => Buffer.from(ListPurgeJobsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListPurgeJobsResponse.decode(value),
  },
  createPurgeRequest: {
    path: "/security.ComplianceService/CreatePurgeRequest",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreatePurgeRequestRequest) =>
      Buffer.from(CreatePurgeRequestRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreatePurgeRequestRequest.decode(value),
    responseSerialize: (value: CreatePurgeRequestResponse) =>
      Buffer.from(CreatePurgeRequestResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreatePurgeRequestResponse.decode(value),
  },
  executePurge: {
    path: "/security.ComplianceService/ExecutePurge",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ExecutePurgeRequest) => Buffer.from(ExecutePurgeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ExecutePurgeRequest.decode(value),
    responseSerialize: (value: ExecutePurgeResponse) => Buffer.from(ExecutePurgeResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ExecutePurgeResponse.decode(value),
  },
  getPurgeRequest: {
    path: "/security.ComplianceService/GetPurgeRequest",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetPurgeRequestRequest) => Buffer.from(GetPurgeRequestRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetPurgeRequestRequest.decode(value),
    responseSerialize: (value: GetPurgeRequestResponse) => Buffer.from(GetPurgeRequestResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetPurgeRequestResponse.decode(value),
  },
  listPurgeRequests: {
    path: "/security.ComplianceService/ListPurgeRequests",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListPurgeRequestsRequest) => Buffer.from(ListPurgeRequestsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListPurgeRequestsRequest.decode(value),
    responseSerialize: (value: ListPurgeRequestsResponse) =>
      Buffer.from(ListPurgeRequestsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListPurgeRequestsResponse.decode(value),
  },
  cancelPurgeRequest: {
    path: "/security.ComplianceService/CancelPurgeRequest",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelPurgeRequestRequest) =>
      Buffer.from(CancelPurgeRequestRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CancelPurgeRequestRequest.decode(value),
    responseSerialize: (value: CancelPurgeRequestResponse) =>
      Buffer.from(CancelPurgeRequestResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CancelPurgeRequestResponse.decode(value),
  },
  placeLegalHold: {
    path: "/security.ComplianceService/PlaceLegalHold",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: PlaceLegalHoldRequest) => Buffer.from(PlaceLegalHoldRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PlaceLegalHoldRequest.decode(value),
    responseSerialize: (value: PlaceLegalHoldResponse) => Buffer.from(PlaceLegalHoldResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => PlaceLegalHoldResponse.decode(value),
  },
  liftLegalHold: {
    path: "/security.ComplianceService/LiftLegalHold",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: LiftLegalHoldRequest) => Buffer.from(LiftLegalHoldRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => LiftLegalHoldRequest.decode(value),
    responseSerialize: (value: LiftLegalHoldResponse) => Buffer.from(LiftLegalHoldResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => LiftLegalHoldResponse.decode(value),
  },
  checkLegalHold: {
    path: "/security.ComplianceService/CheckLegalHold",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CheckLegalHoldRequest) => Buffer.from(CheckLegalHoldRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CheckLegalHoldRequest.decode(value),
    responseSerialize: (value: CheckLegalHoldResponse) => Buffer.from(CheckLegalHoldResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CheckLegalHoldResponse.decode(value),
  },
  generatePurgeProof: {
    path: "/security.ComplianceService/GeneratePurgeProof",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GeneratePurgeProofRequest) =>
      Buffer.from(GeneratePurgeProofRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GeneratePurgeProofRequest.decode(value),
    responseSerialize: (value: GeneratePurgeProofResponse) =>
      Buffer.from(GeneratePurgeProofResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GeneratePurgeProofResponse.decode(value),
  },
} as const;
