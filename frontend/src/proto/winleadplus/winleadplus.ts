...
export const WinLeadPlusConfig: MessageFns<WinLeadPlusConfig> = {
  encode(message: WinLeadPlusConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hasApiToken !== undefined) {
      writer.uint32(72).bool(message.hasApiToken);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.hasApiToken = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): WinLeadPlusConfig {
    return {
      ...
      updatedAt: isSet(object.updatedAt)
        ...
        : "",
      hasApiToken: isSet(object.hasApiToken)
        ? globalThis.Boolean(object.hasApiToken)
        : isSet(object.has_api_token)
        ? globalThis.Boolean(object.has_api_token)
        : undefined,
    };
  },
  ...
  toJSON(message: WinLeadPlusConfig): unknown {
    ...
    if (message.hasApiToken !== undefined) {
      obj.hasApiToken = message.hasApiToken;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<WinLeadPlusConfig>, I>>(object: I): WinLeadPlusConfig {
    ...
    message.hasApiToken = object.hasApiToken ?? undefined;
    return message;
  },
};
...
export const UpdateWinLeadPlusConfigRequest: MessageFns<UpdateWinLeadPlusConfigRequest> = {
  encode(message: UpdateWinLeadPlusConfigRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.apiToken !== undefined) {
      writer.uint32(50).string(message.apiToken);
    }
    return writer;
  },
  ...
  fromJSON(object: any): UpdateWinLeadPlusConfigRequest {
    return {
      ...
      organisationId: isSet(object.organisationId)
        ...
        ? globalThis.String(object.organisation_id)
        : undefined,
      apiToken: isSet(object.apiToken)
        ? globalThis.String(object.apiToken)
        : isSet(object.api_token)
        ? globalThis.String(object.api_token)
        : undefined,
    };
  },
...
function createBaseTestConnectionRequest(): TestConnectionRequest {
  return { organisationId: "", apiEndpoint: "", apiToken: undefined };
}
...
export const TestConnectionRequest: MessageFns<TestConnectionRequest> = {
  encode(message: TestConnectionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.apiToken !== undefined) {
      writer.uint32(26).string(message.apiToken);
    }
    return writer;
  },
