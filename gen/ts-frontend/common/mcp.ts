...
export const ToolsResponse = {
  encode(message: ToolsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ToolsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MCPServiceService = {
  ...
  listTools: {
    ...
    responseSerialize: (value: ToolsResponse) => Buffer.from(ToolsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ToolsResponse.decode(value),
  },
