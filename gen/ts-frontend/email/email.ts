...
export const EmailServiceService = {
  ...
  createMailbox: {
    ...
    requestSerialize: (value: CreateMailboxRequest) => Buffer.from(CreateMailboxRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateMailboxRequest.decode(value),
    responseSerialize: (value: MailboxResponse) => Buffer.from(MailboxResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MailboxResponse.decode(value),
  },
  getMailbox: {
    path: "/email.EmailService/GetMailbox",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetMailboxRequest) => Buffer.from(GetMailboxRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetMailboxRequest.decode(value),
    responseSerialize: (value: MailboxResponse) => Buffer.from(MailboxResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MailboxResponse.decode(value),
  },
  getMailboxesByOrganisation: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetMailboxesByOrganisationRequest) =>
      Buffer.from(GetMailboxesByOrganisationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetMailboxesByOrganisationRequest.decode(value),
    responseSerialize: (value: MailboxListResponse) => Buffer.from(MailboxListResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MailboxListResponse.decode(value),
  },
  getMailboxesBySociete: {
    path: "/email.EmailService/GetMailboxesBySociete",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetMailboxesBySocieteRequest) =>
      Buffer.from(GetMailboxesBySocieteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetMailboxesBySocieteRequest.decode(value),
    responseSerialize: (value: MailboxListResponse) => Buffer.from(MailboxListResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MailboxListResponse.decode(value),
  },
  updateMailbox: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateMailboxRequest) => Buffer.from(UpdateMailboxRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateMailboxRequest.decode(value),
    responseSerialize: (value: MailboxResponse) => Buffer.from(MailboxResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MailboxResponse.decode(value),
  },
  deleteMailbox: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteMailboxRequest) => Buffer.from(DeleteMailboxRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteMailboxRequest.decode(value),
  ...
  getGoogleAuthUrl: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetAuthUrlRequest) => Buffer.from(GetAuthUrlRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetAuthUrlRequest.decode(value),
    responseSerialize: (value: AuthUrlResponse) => Buffer.from(AuthUrlResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AuthUrlResponse.decode(value),
  },
  exchangeGoogleCode: {
  ...
  sendEmailWithTemplate: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendEmailWithTemplateRequest) =>
      Buffer.from(SendEmailWithTemplateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SendEmailWithTemplateRequest.decode(value),
    responseSerialize: (value: SendEmailResponse) => Buffer.from(SendEmailResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SendEmailResponse.decode(value),
  },
  getEmails: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetEmailsRequest) => Buffer.from(GetEmailsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetEmailsRequest.decode(value),
    responseSerialize: (value: EmailListResponse) => Buffer.from(EmailListResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => EmailListResponse.decode(value),
  },
  getEmail: {
    path: "/email.EmailService/GetEmail",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetEmailRequest) => Buffer.from(GetEmailRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetEmailRequest.decode(value),
    responseSerialize: (value: EmailResponse) => Buffer.from(EmailResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => EmailResponse.decode(value),
  },
  /** ===== User Info ===== */
  getGoogleUserInfo: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetUserInfoRequest) => Buffer.from(GetUserInfoRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetUserInfoRequest.decode(value),
    responseSerialize: (value: UserInfoResponse) => Buffer.from(UserInfoResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UserInfoResponse.decode(value),
  },
...
export interface EmailServiceClient extends Client {
  ...
  createMailbox(
    ...
    callback: (error: ServiceError | null, response: MailboxResponse) => void,
  ): ClientUnaryCall;
  createMailbox(
    request: CreateMailboxRequest,
    metadata: Metadata,
  ...
  getMailboxesByOrganisation(
    ...
    callback: (error: ServiceError | null, response: MailboxListResponse) => void,
  ): ClientUnaryCall;
  getMailboxesByOrganisation(
    request: GetMailboxesByOrganisationRequest,
    metadata: Metadata,
  ...
  getGoogleAuthUrl(
    ...
    callback: (error: ServiceError | null, response: AuthUrlResponse) => void,
  ): ClientUnaryCall;
  getGoogleAuthUrl(
    request: GetAuthUrlRequest,
    metadata: Metadata,
  ...
  getEmails(
    ...
    callback: (error: ServiceError | null, response: EmailListResponse) => void,
  ): ClientUnaryCall;
  getEmails(
    request: GetEmailsRequest,
    metadata: Metadata,
  ...
  getEmail(
    ...
    callback: (error: ServiceError | null, response: EmailResponse) => void,
  ): ClientUnaryCall;
  getEmail(
    request: GetEmailRequest,
    metadata: Metadata,
