...
export function mailProviderFromJSON(object: any): MailProvider {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum MailProvider");
  }
}
...
export function connectionTypeFromJSON(object: any): ConnectionType {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum ConnectionType");
  }
}
