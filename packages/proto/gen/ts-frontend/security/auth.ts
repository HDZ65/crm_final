...
export function mfaMethodFromJSON(object: any): MfaMethod {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum MfaMethod");
  }
}
...
export function breakglassStatusFromJSON(object: any): BreakglassStatus {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum BreakglassStatus");
  }
}
