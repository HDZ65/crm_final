...
exports.SERVICE_REGISTRY = void 0;
...
function getServiceConfig(serviceName) {
    ...
    if (!config) {
        throw new Error(`Unknown service: ${serviceName}. Valid services: ${Object.keys(exports.SERVICE_REGISTRY).join(', ')}`);
    }
    return config;
}
function getServiceUrl(serviceName, host) {
