...
export const SERVICE_REGISTRY: Record<string, ServiceConfig> = {
  ...
  'commission-crud': {
    package: 'commission',
    protoFile: 'commission/commission-crud.proto',
    defaultPort: 50054,
    serviceName: 'CommissionCrudService',
  },
  'commission-bordereau': {
    package: 'commission',
    protoFile: 'commission/commission-bordereau.proto',
    defaultPort: 50054,
    serviceName: 'CommissionBordereauService',
  },
  'commission-calculation': {
    package: 'commission',
    protoFile: 'commission/commission-calculation.proto',
    defaultPort: 50054,
    serviceName: 'CommissionCalculationService',
  },
  'commission-contestation': {
    package: 'commission',
    protoFile: 'commission/commission-contestation.proto',
    defaultPort: 50054,
    serviceName: 'CommissionContestationService',
  },
  'commission-validation': {
    package: 'commission',
    protoFile: 'commission/commission-validation.proto',
    defaultPort: 50054,
    serviceName: 'CommissionValidationService',
  },
  'commission-dashboard': {
    package: 'commission',
    protoFile: 'commission/commission-dashboard.proto',
    defaultPort: 50054,
    serviceName: 'CommissionDashboardService',
  },
  contrats: {
    package: 'contrats',
  ...
  cfast: {
    package: 'cfast',
    protoFile: 'cfast/cfast.proto',
    defaultPort: 50053,
    serviceName: 'CfastConfigService',
  },
  qualite: {
    package: 'qualite',
    protoFile: 'qualite/qualite.proto',
    defaultPort: 50053,
    serviceName: 'ControleQualiteService',
  },
} as const;
