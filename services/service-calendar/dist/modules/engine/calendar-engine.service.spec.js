...
describe('CalendarEngineService', () => {
    ...
    const mockEligibleDate = {
        isEligible: true,
        isWeekend: false,
        isHoliday: false,
    };
    const mockWeekendDate = {
        isEligible: false,
        isWeekend: true,
        isHoliday: false,
        reason: 'Saturday',
    ...
    beforeEach(async () => {
        ...
        service = module.get(CalendarEngineService);
    ...
    describe('calculatePlannedDate', () => {
        ...
        it('should throw CalendarError when batch is required but not provided', async () => {
            ...
            await expect(service.calculatePlannedDate({
                organisationId: 'org-1',
                targetMonth: 3,
                targetYear: 2026,
...
//# sourceMappingURL=calendar-engine.service.spec.js.map