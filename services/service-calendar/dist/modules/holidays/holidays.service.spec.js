...
describe('HolidaysService', () => {
    ...
    describe('getHolidaysForYear', () => {
        ...
        it('should throw HolidaysError when zone not found', async () => {
            ...
            await expect(service.getHolidaysForRange('zone-invalid', new Date('2026-01-01'), new Date('2026-12-31'))).rejects.toThrow(HolidaysError);
        });
    });
    ...
    describe('createHoliday', () => {
        it('should create a new holiday', async () => {
            ...
            const result = await service.createHoliday('zone-fr', new Date('2026-01-01'), 'Jour de l\'An', 'PUBLIC', true);
            expect(result.name).toBe('Jour de l\'An');
        });
        it('should throw HolidaysError when zone not found', async () => {
            mockHolidayZoneRepo.findOne.mockResolvedValue(null);
            await expect(service.createHoliday('zone-invalid', new Date(), 'Test', 'PUBLIC')).rejects.toThrow(HolidaysError);
        });
    });
...
//# sourceMappingURL=holidays.service.spec.js.map