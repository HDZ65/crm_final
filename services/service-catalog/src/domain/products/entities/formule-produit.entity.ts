...
import { FormuleRecurrenceEnum } from '../enums/formule-recurrence.enum';
...
export class FormuleProduitEntity {
  ...
  @Column({ name: 'recurrence', type: 'enum', enum: FormuleRecurrenceEnum, nullable: true, default: 'monthly' })
  recurrence: FormuleRecurrenceEnum | null;

  @Column({ name: 'billing_cycle_days', type: 'int', nullable: true })
