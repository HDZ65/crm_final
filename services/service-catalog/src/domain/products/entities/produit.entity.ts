...
import { ProductBadgeEntity } from './product-badge.entity';
...
@Entity('produit')
@Index(['keycloakGroupId', 'sku'], { unique: true })
export class ProduitEntity {
  ...
  @Column({ name: 'revenue_model', type: 'enum', enum: RevenueModelEnum, nullable: true, default: 'revenue' })
  revenueModel: RevenueModelEnum | null;
