...
import { SubscriptionCycleEntity } from './subscription-cycle.entity';
...
@Index(['keycloakGroupId', 'nextChargeAt'])
export class SubscriptionEntity {
  ...
  lines: Relation<SubscriptionLineEntity[]>;

  @OneToMany(() => SubscriptionHistoryEntity, (history) => history.subscription)
  history: Relation<SubscriptionHistoryEntity[]>;

  @OneToMany(() => SubscriptionCycleEntity, (cycle) => cycle.subscription)
  cycles: Relation<SubscriptionCycleEntity[]>;

  @OneToMany(() => SubscriptionStatusHistoryEntity, (status) => status.subscription)
  statusHistory: Relation<SubscriptionStatusHistoryEntity[]>;
