...
export class CreateTvodEstPurchases1770510000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TYPE tvod_store_source_enum AS ENUM ('DIRECT', 'APPLE', 'GOOGLE')
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE tvod_est_purchases (
        ...
        store_source tvod_store_source_enum NOT NULL,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE IF EXISTS tvod_store_source_enum`);
