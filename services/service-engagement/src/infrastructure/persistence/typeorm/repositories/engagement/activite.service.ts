...
export class ActiviteService {
  ...
  async create(data: Partial<ActiviteEntity>): Promise<ActiviteEntity> {
    const activite = this.activiteRepository.create(data);
    return this.activiteRepository.save(activite);
  }

  async update(id: string, data: Partial<ActiviteEntity>): Promise<ActiviteEntity> {
    const activite = await this.findById(id);
    Object.assign(activite, data);
    return this.activiteRepository.save(activite);
  }

  async findById(id: string): Promise<ActiviteEntity> {
