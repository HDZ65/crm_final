...
import { NotificationType, NotificationEntity } from './entities/notification.entity';
...
export class NotificationController {
  ...
  private toGrpcNotification(notification: NotificationEntity): ProtoNotification {
    return {
      id: notification.id,
      ...
      lienUrl: notification.lienUrl ?? undefined,
