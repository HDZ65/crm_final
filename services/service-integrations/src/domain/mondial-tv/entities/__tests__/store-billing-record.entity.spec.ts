...
describe('StoreBillingRecordEntity', () => {
  ...
  describe('Entity Creation', () => {
    it('should create a store billing record with all fields', () => {
      ...
      expect(entity.keycloakGroupId).toBeDefined();
  ...
  describe('Multi-Tenancy', () => {
    it('should isolate records by organisation', () => {
      ...
      entity.keycloakGroupId = org1;
      expect(entity.keycloakGroupId).toBe(org1);

      entity.keycloakGroupId = org2;
      expect(entity.keycloakGroupId).toBe(org2);
    });
