import { ImsWebhookEventEntity, ImsWebhookProcessingStatus } from '../entities/ims-webhook-event.entity';
...
export interface IImsWebhookEventRepository {
  ...
  findByStatus(status: ImsWebhookProcessingStatus, limit?: number): Promise<ImsWebhookEventEntity[]>;
  create(input: {
